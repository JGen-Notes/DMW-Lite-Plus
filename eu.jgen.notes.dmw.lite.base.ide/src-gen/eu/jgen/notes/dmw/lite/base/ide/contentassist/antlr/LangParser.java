...
public class LangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getYEnumerationAccess().getGroup_3(), "rule__YEnumeration__Group_3__0");
			builder.put(grammarAccess.getYEnumerationCaseAccess().getGroup(), "rule__YEnumerationCase__Group__0");
			builder.put(grammarAccess.getYEnumerationCaseAccess().getGroup_3(), "rule__YEnumerationCase__Group_3__0");
			builder.put(grammarAccess.getYEnumerationCaseAccess().getGroup_3_1(), "rule__YEnumerationCase__Group_3_1__0");
			builder.put(grammarAccess.getYEnumerationCaseAccess().getGroup_3_1_1(), "rule__YEnumerationCase__Group_3_1_1__0");
			...
			builder.put(grammarAccess.getYDoStatementAccess().getGroup(), "rule__YDoStatement__Group__0");
			builder.put(grammarAccess.getYCatchAccess().getGroup(), "rule__YCatch__Group__0");
			builder.put(grammarAccess.getYCatchBlockAccess().getGroup(), "rule__YCatchBlock__Group__0");
			builder.put(grammarAccess.getYVariableDeclarationAccess().getGroup(), "rule__YVariableDeclaration__Group__0");
			builder.put(grammarAccess.getYThrowAccess().getGroup(), "rule__YThrow__Group__0");
			builder.put(grammarAccess.getYThrowAccess().getGroup_4(), "rule__YThrow__Group_4__0");
			builder.put(grammarAccess.getYThrowAccess().getGroup_4_1(), "rule__YThrow__Group_4_1__0");
			...
			builder.put(grammarAccess.getYWidgetAccess().getEnumsAssignment_4(), "rule__YWidget__EnumsAssignment_4");
			builder.put(grammarAccess.getYWidgetAccess().getClassesAssignment_5(), "rule__YWidget__ClassesAssignment_5");
			...
			builder.put(grammarAccess.getYEnumerationAccess().getNameAssignment_2(), "rule__YEnumeration__NameAssignment_2");
			builder.put(grammarAccess.getYEnumerationAccess().getSuperclassAssignment_3_1(), "rule__YEnumeration__SuperclassAssignment_3_1");
			builder.put(grammarAccess.getYEnumerationAccess().getCasesAssignment_5(), "rule__YEnumeration__CasesAssignment_5");
			builder.put(grammarAccess.getYEnumerationCaseAccess().getNameAssignment_2(), "rule__YEnumerationCase__NameAssignment_2");
			builder.put(grammarAccess.getYEnumerationCaseAccess().getParamsAssignment_3_1_0(), "rule__YEnumerationCase__ParamsAssignment_3_1_0");
			builder.put(grammarAccess.getYEnumerationCaseAccess().getParamsAssignment_3_1_1_1(), "rule__YEnumerationCase__ParamsAssignment_3_1_1_1");
			...
			builder.put(grammarAccess.getYFunctionAccess().getThrowAssignment_6(), "rule__YFunction__ThrowAssignment_6");
			builder.put(grammarAccess.getYFunctionAccess().getReturnvalueAssignment_7(), "rule__YFunction__ReturnvalueAssignment_7");
			builder.put(grammarAccess.getYFunctionAccess().getTypeAssignment_8(), "rule__YFunction__TypeAssignment_8");
			builder.put(grammarAccess.getYFunctionAccess().getBodyAssignment_9(), "rule__YFunction__BodyAssignment_9");
			builder.put(grammarAccess.getYBlockAccess().getStatementsAssignment_2(), "rule__YBlock__StatementsAssignment_2");
			builder.put(grammarAccess.getYDoStatementAccess().getBlockAssignment_2(), "rule__YDoStatement__BlockAssignment_2");
			builder.put(grammarAccess.getYDoStatementAccess().getCatchesAssignment_3(), "rule__YDoStatement__CatchesAssignment_3");
			builder.put(grammarAccess.getYCatchAccess().getExceptionAssignment_2(), "rule__YCatch__ExceptionAssignment_2");
			builder.put(grammarAccess.getYCatchAccess().getCatchBlockAssignment_3(), "rule__YCatch__CatchBlockAssignment_3");
			builder.put(grammarAccess.getYCatchBlockAccess().getStatementsAssignment_2(), "rule__YCatchBlock__StatementsAssignment_2");
			...
			builder.put(grammarAccess.getYThrowAccess().getExceptionAssignment_2(), "rule__YThrow__ExceptionAssignment_2");
			builder.put(grammarAccess.getYThrowAccess().getArgumentsAssignment_4_0(), "rule__YThrow__ArgumentsAssignment_4_0");
			builder.put(grammarAccess.getYThrowAccess().getArgumentsAssignment_4_1_1(), "rule__YThrow__ArgumentsAssignment_4_1_1");
			...
			builder.put(grammarAccess.getYCreateStatementAccess().getSetBlockAssignment_3(), "rule__YCreateStatement__SetBlockAssignment_3");
			builder.put(grammarAccess.getYUpdateStatementAccess().getStructAssignment_1(), "rule__YUpdateStatement__StructAssignment_1");
			builder.put(grammarAccess.getYUpdateStatementAccess().getSetBlockAssignment_3(), "rule__YUpdateStatement__SetBlockAssignment_3");
